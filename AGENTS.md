...
-   When you add a major new feature, write tests that cover that feature end-to-end within the existing suite.
...
-   IDX\_\* environment variables map directly to PropTx RESO OData API credentials.
...
-   The PropTx API does not support Odata Nextlink. Refer to the replication guide in the documents folder replication-example.md
